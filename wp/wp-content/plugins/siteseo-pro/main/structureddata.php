...
class StructuredData{
	...
	static function display_metabox(){
		...
		echo'<div class="siteseo-metabox-schema" class="siteseo_schema_properties_container" class="'.(empty($schema_type) || $schema_type === 'CustomSchema' ? 'hidden' : '').'">
		...
		<div class="siteseo_custom_schema_container'.((empty($schema_type) || $schema_type !== 'CustomSchema') ? ' hidden' : '').'">
