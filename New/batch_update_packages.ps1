# PowerShell script to batch-update all package files
...
$files = Get-ChildItem "C:\Users\USER\Desktop\Jetwide-web\pages\packages\*.html"
$updated = 0
$skipped = 0
...
Write-Host "`n✓ Updated: $updated files" -ForegroundColor Cyan
